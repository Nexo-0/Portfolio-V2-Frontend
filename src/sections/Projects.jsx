...
import railwayImg from "../assets/Images/projects/railwayBook.png";
  ...
  const featuredProjects = [
    {
      ...
      desc: "Full-stack railway ticket booking system with secure user authentication and reservation management. Built with a React frontend and a Java-based backend connected to an Oracle Cloud Database.",
      tags: ["React", "Java", "Oracle Database", "REST API"],
      image: railwayImg,
      status: "Featured",
      link: "https://railway-reservation-system-frontend.onrender.com/",
    },
    {
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <div className="flex flex-wrap gap-2 mt-auto">
                {project.tags.map((tag, i) => (
                  <span
                    key={i}
                    className="text-xs font-medium px-3 py-1 bg-white/5 rounded-full text-primary"
                  >
                    {tag}
                  </span>
                ))}
